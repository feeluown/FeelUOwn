...
- 功能增强
  ...
  - 支持 XDG 基础目录规范 #1020
  - 在 nowplaying 页面增加返回按钮 #1017
  - 多语言支持：提供接口让插件支持多语言 #1018
  - 支持展示歌单描述 #1026
...
- 功能增强
  ...
  - 发现页支持分区推荐集合展示，推荐内容层次更清晰 #1004
  - 新增 MCP Server（实验性），并补齐 provider 协议能力映射（资源、检索、详情、歌单读写等） #1005 #1009
  - 封面加载支持 provider image media，提升资源方图片兼容性 #1006
...
- 测试与工程
  ...
  - 修复 `test_table_meta` 用例，保持测试在新环境下稳定 #996
