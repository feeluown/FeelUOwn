...
class SongsTableToolbar(QWidget):
    ...
    show_albums2_needed = pyqtSignal()
    show_albums3_needed = pyqtSignal()
    ...
    def __init__(self, parent=None):
        ...
        self.show_albums2_btn = QPushButton(parent=self)
        self.show_albums3_btn = QPushButton(parent=self)
        ...
        self.show_albums2_btn.clicked.connect(self.show_albums2_needed.emit)
        self.show_albums3_btn.clicked.connect(self.show_albums3_needed.emit)
        self.desc_btn.clicked.connect(self.on_desc_btn_toggled)

        self.show_songs_btn.hide()
        self.show_albums_btn.hide()
        # self.show_videos_btn.hide()
        self.show_albums2_btn.hide()
        self.show_albums3_btn.hide()
        self._setup_ui()

    def artist_mode(self):
        self.show_songs_btn.setText('歌曲')
        self.show_albums_btn.setText('专辑')
        # self.show_videos_btn.setText('音乐视频')
        self.show_albums2_btn.setText('单曲与EP')
        self.show_albums3_btn.setText('参与作品')
        self.show_songs_btn.show()
        self.show_albums_btn.show()
        # self.show_videos_btn.show()
        self.show_albums2_btn.show()
        self.show_albums3_btn.show()
    ...
    def _setup_ui(self):
        ...
        # self._layout.addSpacing(5)
        # self._layout.addWidget(self.show_videos_btn)
        self._layout.addSpacing(5)
        self._layout.addWidget(self.show_albums2_btn)
        self._layout.addSpacing(5)
        self._layout.addWidget(self.show_albums3_btn)
