...
class SongsTableToolbar(QWidget):
    ...
    show_mini_albums_needed = pyqtSignal()
    ...
    def __init__(self, parent=None):
        ...
        self.show_mini_albums_btn = QPushButton(parent=self)
        self.show_contributed_albums_btn = QPushButton(parent=self)
        ...
        self.show_mini_albums_btn.clicked.connect(self.show_mini_albums_needed.emit)
        ...
        self.show_mini_albums_btn.hide()
    ...
    def artist_mode(self):
        ...
        self.show_mini_albums_btn.setText('单曲与EP')
        self.show_contributed_albums_btn.setText('参与作品')
        self.show_songs_btn.show()
        self.show_albums_btn.show()
        # self.show_videos_btn.show()
        self.show_mini_albums_btn.show()
    ...
    def _setup_ui(self):
        ...
        self._layout.addSpacing(5)
        self._layout.addWidget(self.show_mini_albums_btn)
        self._layout.addSpacing(5)
